...
const DatePicker = ({
  ...
  const toggleMode = (newMode) => {
    setMode(mode === newMode ? "day" : newMode);
  };
  ...
  const yearRange = [];
  const baseYear = maximumDate
    ? maximumDate.getFullYear()
    : today.getFullYear();
  const startYear = baseYear - 5;
  const endYear = baseYear - 15;
    ...
    <View style={styles.wrapper}>
      ...
      <TouchableOpacity
        style={[
          ...
          visible && styles.selectorFocused,
        ]}
        ...
        >
          ...
          >
            ...
            <View style={styles.pickerHeader}>
              ...
              {/* Header with Month/Year tabs */}
              <View style={styles.modeTabs}>
                <TouchableOpacity
                  style={[
                    styles.modeTab,
                    mode === "month" && styles.modeTabActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.modeTabText,
                      mode === "month" && styles.modeTabTextActive,
                    ]}
                  >
                    {MONTHS[viewMonth]}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.modeTab,
                    mode === "year" && styles.modeTabActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.modeTabText,
                      mode === "year" && styles.modeTabTextActive,
                    ]}
                  >
                    {viewYear}
                  </Text>
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    style={[
                      styles.yearItem,
                      viewYear === item && styles.yearItemActive,
                    ]}
                    onPress={() => {
                      setViewYear(item);
                      setMode("day");
                  ...
                  >
                    <Text
                      style={[
                        styles.yearItemText,
                        viewYear === item && styles.yearItemTextActive,
                      ]}
                    >
                      {item}
                    </Text>
...
const styles = StyleSheet.create({
  ...
  modeTabText: { fontSize: 15, fontWeight: "600", color: "#BFDBFE" },
